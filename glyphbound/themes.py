...
from .dungeon import VOID, FLOOR, WALL, DOOR_CLOSED, DOOR_OPEN, STAIR_DOWN, STAIR_UP, SHOP
...
THEME_LIBRARY = Theme(
    name="Library",
    glyphs={VOID: " ", FLOOR: ".", WALL: "#", DOOR_CLOSED: "+", DOOR_OPEN: "/", STAIR_DOWN: ">", STAIR_UP: "<", SHOP: "$"},
    tile_styles={
        ...
        DOOR_CLOSED: Style(color="bright_yellow",  bgcolor=_BG, bold=True),
        ...
        SHOP:        Style(color="bright_yellow", bgcolor=_BG, bold=True),
    },
...
THEME_LIVING = Theme(
    name="Living Dungeon",
    glyphs={VOID: " ", FLOOR: ",", WALL: "O", DOOR_CLOSED: "V", DOOR_OPEN: "v", STAIR_DOWN: ">", STAIR_UP: "<", SHOP: "$"},
    tile_styles={
        VOID:        Style(color="black",          bgcolor=_BG),
        FLOOR:       Style(color="dark_sea_green4", bgcolor=_BG),
        WALL:        Style(color="pale_green3",     bgcolor=_BG, bold=True),
        DOOR_CLOSED: Style(color="bright_green",    bgcolor=_BG, bold=True),
...
THEME_JAIL = Theme(
    ...
    tile_styles={
        ...
        DOOR_CLOSED: Style(color="bright_cyan",   bgcolor=_BG, bold=True),
...
THEME_CATACOMBS = Theme(
    ...
    tile_styles={
        ...
        DOOR_CLOSED: Style(color="bright_red",  bgcolor=_BG, bold=True),
...
THEME_RITUAL = Theme(
    name="Ritual Sanctum",
    glyphs={VOID: " ", FLOOR: "*", WALL: "#", DOOR_CLOSED: "X", DOOR_OPEN: "x", STAIR_DOWN: ">", STAIR_UP: "<", SHOP: "$"},
    tile_styles={
        VOID:        Style(color="black",           bgcolor=_BG),
        FLOOR:       Style(color="medium_purple3",  bgcolor=_BG),
        WALL:        Style(color="plum4",           bgcolor=_BG, bold=True),
        DOOR_CLOSED: Style(color="bright_magenta",  bgcolor=_BG, bold=True),
...
THEME_CAVERNS = Theme(
    ...
    tile_styles={
        ...
        DOOR_CLOSED: Style(color="bright_white",    bgcolor=_BG, bold=True),
